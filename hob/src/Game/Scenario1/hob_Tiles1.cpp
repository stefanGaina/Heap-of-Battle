	...
	, TileInitializer{
		{
			...
			textureContainer[1].getRawTexture(),  textureContainer[2].getRawTexture(),	textureContainer[3].getRawTexture(),

			textureContainer[4].getRawTexture(), /*< 1 */
			textureContainer[5].getRawTexture(),  textureContainer[6].getRawTexture(),	textureContainer[4].getRawTexture(),

			textureContainer[7].getRawTexture(), /*< 2 */
			textureContainer[8].getRawTexture(),  textureContainer[9].getRawTexture(),	textureContainer[7].getRawTexture(),

			textureContainer[10].getRawTexture(), /*< 3 */
			textureContainer[11].getRawTexture(), textureContainer[12].getRawTexture(), textureContainer[10].getRawTexture(),

			textureContainer[13].getRawTexture(), /*< 4 */
			textureContainer[14].getRawTexture(), textureContainer[15].getRawTexture(), textureContainer[13].getRawTexture(),

			textureContainer[16].getRawTexture(), /*< 5 */
			textureContainer[17].getRawTexture(), textureContainer[18].getRawTexture(), textureContainer[16].getRawTexture(),

			textureContainer[19].getRawTexture(), /*< 6 */
			textureContainer[20].getRawTexture(), textureContainer[21].getRawTexture(), textureContainer[19].getRawTexture(),

			textureContainer[22].getRawTexture(), /*< 7 */
			textureContainer[27].getRawTexture(), textureContainer[28].getRawTexture(), textureContainer[29].getRawTexture(),
		...
		},
		{
			...
			/* 3  */ 11, 11, 11, 11, 11, 11, 12, 0,	 0,	 8, 3, 1, 2, 1, 2, 5, 10, 0,  0,  12, 11, 11, 12, 0,  12, 0,
			/* 4  */ 0,	 0,	 0,	 12, 11, 11, 12, 0,	 0,	 8, 3, 1, 1, 1, 1, 6, 10, 0,  0,  12, 11, 11, 12, 0,  0,  0,
			/* 5  */ 0,	 0,	 0,	 0,	 12, 12, 0,	 0,	 0,	 8, 4, 1, 2, 2, 2, 6, 10, 0,  0,  0,  12, 12, 0,  0,  0,  0,
			/* 6  */ 11, 11, 11, 0,	 0,	 0,	 0,	 11, 11, 7, 4, 2, 2, 1, 1, 5, 9,  11, 11, 0,  0,  0,  0,  11, 11, 11,
			/* 7  */ 11, 11, 11, 12, 0,	 0,	 12, 11, 11, 7, 4, 1, 1, 2, 1, 6, 9,  11, 11, 12, 0,  0,  12, 11, 11, 11,
			/* 8  */ 11, 11, 11, 0,	 0,	 0,	 0,	 11, 11, 7, 3, 1, 2, 2, 1, 6, 9,  11, 11, 0,  0,  0,  0,  11, 11, 11,
			/* 9  */ 0,	 0,	 0,	 0,	 12, 12, 0,	 0,	 0,	 8, 4, 1, 1, 1, 1, 6, 10, 0,  0,  0,  12, 12, 0,  0,  0,  0,
			/* 10 */ 0,	 0,	 0,	 12, 11, 11, 12, 0,	 0,	 8, 4, 2, 2, 2, 2, 5, 10, 0,  0,  12, 11, 11, 12, 0,  0,  0,
			/* 11 */ 11, 11, 11, 11, 11, 11, 12, 0,	 0,	 8, 3, 2, 1, 1, 2, 5, 10, 0,  0,  12, 11, 11, 12, 0,  12, 0,
			/* 12 */ 11, 11, 11, 11, 12, 12, 0,	 0,	 0,	 8, 4, 1, 2, 1, 2, 6, 10, 0,  0,  0,  12, 12, 0,  11, 11, 11,
			/* 13 */ 11, 11, 11, 11, 0,	 0,	 0,	 0,	 11, 7, 3, 2, 1, 2, 1, 6, 9,  11, 0,  0,  0,  0,  0,  11, 11, 11,
			/* 14 */ 11, 11, 11, 11, 12, 0,	 0,	 12, 11, 7, 3, 2, 1, 1, 1, 5, 9,  11, 12, 0,  0,  0,  0,  11, 11, 11,
		}
	}
{
