 ...
 * @author Gaina Stefan
 * @date 26.08.2023
 * @brief This file defines the class and method prototypes of the ping.
 * @todo N/A.
 * @bug No known bugs.
 *****************************************************************************************************/
...
public:
	...
	/** ***********************************************************************************************
	 * @brief Joins the thread without destroying font and texture. Useful when wanting to call clean()
