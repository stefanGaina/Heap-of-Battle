 ...
 * @author Gaina Stefan
 * @date 23.07.2023
 * @brief This file defines the class and method prototypes of the loop.
 * @todo N/A.
 * @bug No known bugs.
 *****************************************************************************************************/
 ...
 * @details This class should be inherited by every scene class because it provides rendering, exposes
 * the start() and stop() methods, handles ping and draws the cursor.
 *****************************************************************************************************/
class Loop
{
public:
