...
/** ***************************************************************************************************
 * @brief Transforms the faction from boolean to string format.
 * @param isAlliance: true - Alliance, false - Horde.
 * @return The faction in string format.
 *****************************************************************************************************/
#define FACTION_TO_STRING(isAlliance) true == isAlliance ? "Alliance" : "Horde"
 ...
 *****************************************************************************************************/
inline constexpr int32_t SCALE = 80;

/** ***************************************************************************************************
 * @brief The length in pixels of a smaller graphical unit.
 *****************************************************************************************************/
inline constexpr int32_t HSCALE = SCALE / 2;

/** ***************************************************************************************************
 * @brief The width in pixels of the window.
 *****************************************************************************************************/
inline constexpr int32_t SCREEN_WIDTH = 16 * SCALE;

/** ***************************************************************************************************
 * @brief The height in pixels of the window.
 *****************************************************************************************************/
inline constexpr int32_t SCREEN_HEIGHT = 9 * SCALE;
