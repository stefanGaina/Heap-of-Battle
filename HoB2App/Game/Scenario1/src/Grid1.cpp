/** @file Grid1.cpp
 *  @brief Method implementation for the grid of the grid of scenario 1.
 *
 *  @author Gaina Stefan
 *  @bug No known bugs.
 */
...
/**
 * @brief Factor determining how opaque the lines drawn will be (0 - transparent, 255 - fully opaque).
*/
...
{
	RawRenderer renderer  = Window::Renderer::getInstance().load();
	Color       color     = {};
