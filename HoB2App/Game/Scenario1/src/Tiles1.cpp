/** @file Tiles1.cpp
 *  @brief Method implementation for the tiles of scenario number 1.
 *
 *  @author Gaina Stefan
 *  @bug No known bugs.
 */
...
Tiles1::Tiles1(void)
	...
	, TileInitializer
	{
		...
		},
		{
			...
			0 , 0 , 0 , 0 , 12, 11, 11, 12, 0 , 8, 2, 1, 1, 1, 1, 6, 10, 0 , 12, 11, 11, 12, 0 , 0 , 0 , 0 ,
...
Tiles1::~Tiles1(void)
{
	plog_trace("Tiles1 are being destructed.");
}
